        ...
        <div class="col-md-12">
          <div class="card card-primary card-outline">
            <div class="card-header with-border">
              <h3 class="card-title"><?= lang('entries_views_views_title') ?></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
				<?php
					...
					echo '<table class="stripped" id="view_entries_table">';
            ...
            <div class="card-footer">
            	<div class="float-right">
            		<a href="<?= base_url('entries/export/').$entrytype['label'].'/'.$entry['id'];?>/xls" class="btn btn-info"><?=lang('export_to_xls');?></a>
								<a href="<?= base_url('entries/view/').$entrytype['label'].'/'.$entry['id'];?>/pdf" class="btn btn-info"><?=lang('export_to_pdf');?></a>
