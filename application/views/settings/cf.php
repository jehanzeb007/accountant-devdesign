    ...
    <div class="col-md-12">
      <div class="card card-primary card-outline">
        <!-- <div class="card-header with-border">
          <h3 class="card-title"><?= lang('settings_views_cf_title'); ?></h3>
        </div> -->
        <!-- /.card-header -->
        <div class="card-body">
	                    ...
	                    <div class="input-group">
	            			...
	            			<div class="input-group-append">
	                            <span class="input-group-text">
	                                <i class="fas fa-info-circle" data-toggle="tooltip" title="<?php echo lang('settings_views_cf_label_tooltip');?>"></i>
	                            </span>
	                        </div>
	                    </div>
	                    <!-- /.input group -->
	            ...
	            <div class="col-md-4">
	            	<div class="form-group">
	                    ...
	                    <div class="input-group">
	                		...
	                		<div class="input-group-append">
	                            <span class="input-group-text">
	                                <i class="fas fa-info-circle" data-toggle="tooltip" title="<?php echo lang('settings_views_cf_prefix_tooltip');?>"></i>
	                            </span>
	                        </div>
	                    </div>
	                    <!-- /.input group -->
        ...
        <div class="card-footer">
        	<div class="form-group">
	            <?= form_submit('submit', lang('submit'), array('class'=> 'btn btn-primary float-right')); ?>
            </div>
          <?= form_close(); ?>
        </div>
      </div>
