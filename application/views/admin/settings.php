          ...
          <div class="card card-primary card-outline">
            ...
            <?= form_open('admin/settings'); ?>
              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  <div class="row">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <span class="input-group-text">
                                    <i class="fas fa-info-circle" data-toggle="tooltip" title="<?php echo lang('admin_settings_in_entries_use_tooltip');?>"></i>
                                </span>
                            </div>
                        </div>
                        <!-- /.input group -->
                    ...
                    <div class="col-md-6">
                      <div class="form-group float-right" style="padding-top: 40px;">
                        <div class="input-group">
                            ...
                            <div class="input-group-append" style="margin-left: 50px;">
                                <span class="input-group-text">
                                    <i class="fas fa-info-circle" data-toggle="tooltip" title="<?php echo lang('admin_settings_enable_logging_tooltip');?>"></i>
                                </span>
                            </div>
                        </div>
                        <!-- /.input group -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group" style="padding-top: 40px; margin-left: 20px;">
                        <div class="input-group">
                            <label><input type="checkbox" name="dark_mode" <?= ($settings->dark_mode) ? "checked" : "" ?>> <?= lang('admin_settings_dark_mode_label'); ?></label>
              ...
              <div class="card-footer">
                ...
                <a style="margin-right: 5px;" href="<?= base_url(); ?>admin/" id="cancel" name="cancel" class="btn btn-danger float-right"><?=lang('admin_settings_cancel_btn');?></a>
              </div>
            <?= form_close(); ?>
          </div>
          <!-- /.card -->
