        ...
        <div class="col-md-12">
          <div class="card card-primary card-outline">
            <!-- <div class="card-header with-border">
              <h3 class="card-title"><?= lang('ledgers_views_add_title'); ?></h3>
            </div> -->
            <!-- /.card-header -->
            <div class="card-body">
				...
				<div class="ledgers add form">
						...
						<div class="form-group">
							...
							<div class="row">
		                        ...
		                        <div class="input-group-append">
			                          ...
			                          <i class="fas fa-info-circle" data-toggle="tooltip" title="<?php echo lang('ledgers_views_add_op_blnc_tooltip');?>"></i>
			                        </span>
			                      </div>
		                    </div>
		                    <!-- /.input group -->
					...
					<div class="row">
                  	...
                  	<span class="input-group-text">
                      <i class="fas fa-info-circle" data-toggle="tooltip" title="<?php echo lang('ledgers_views_add_bank_cash_account_tooltip');?>"></i>
                    </span>
                  </div>
								</div>
								<!-- /.input group -->
              ...
              <div class="form-group">
                  <div class="input-group">
                      ...
                      <div class="input-group-append" style="margin-left: 10px;">
                      	<span class="input-group-text">
                          <i class="fas fa-info-circle" data-toggle="tooltip" title="<?php echo lang('ledgers_views_add_reconciliation_tooltip');?>"></i>
                        </span>
                      </div>
                  </div>
                  <!-- /.input group -->
            ...
            <div class="card-footer">
            	<div class="form-group">
					...
					<a href="<?=base_url(); ?>accounts" class="btn btn-danger float-right" style="margin-right: 5px;"><?= lang('ledgers_views_add_label_cancel_btn'); ?></a>
				</div>
		    </div>
		    <?= form_close(); ?>
        </div>
