...
class Admin extends Admin_Controller {
	...
	public function index() {
		...
		// var_dump($this->ion_auth->users());die();
		$this->data['user_count'] = $this->ion_auth->users()->num_rows();//count($this->ion_auth->users()->num_rows());
	...
	{
		if ($this->mSettings->dark_mode) {
			$this->db->update('settings', array('dark_mode' => '0'));
		} else {
			$this->db->update('settings', array('dark_mode' => '1'));
		}
		echo ('true');
	}
	...
	public function import_existing_account()
	{
		...
		if ($this->form_validation->run() == TRUE) {			
			...
			if (!$this->check_database($new_config)) {
				...
				redirect('admin/import_existing_account');
			}
			...
			if ($table_exisits == false) {
				$this->session->set_userdata('post_data', $_POST);
				$this->session->set_flashdata('warning', sprintf(lang('admin_cntrler_database_not_existed_warning'), $table, $new_config['database']));
				redirect('admin/import_existing_account');
			} else {
				$insert_data = array(
			...
			$this->data['label'] = array(
				...
				'id'    => 'label',
				'type'  => 'text',
				'value' => $this->form_validation->set_value('label', (isset($this->session->userdata('post_data')['label']) ? $this->session->userdata('post_data')['label'] : '')),
				'class' => 'form-control',
			);
			$this->data['name'] = array(
				...
				'id'    => 'name',
				'type'  => 'text',
				'value' => $this->form_validation->set_value('name', (isset($this->session->userdata('post_data')['name']) ? $this->session->userdata('post_data')['name'] : '')),
				'class' => 'form-control',
			);
			$this->data['fiscal_start'] = array(
				...
				'id'    => 'fiscal_start',
				'type'  => 'text',
				'value' => $this->form_validation->set_value('fiscal_start', (isset($this->session->userdata('post_data')['fiscal_start']) ? $this->session->userdata('post_data')['fiscal_start'] : '')),
				'class' => 'form-control',
			);
			$this->data['fiscal_end'] = array(
				...
				'id'    => 'fiscal_end',
				'type'  => 'text',
				'value' => $this->form_validation->set_value('fiscal_end', (isset($this->session->userdata('post_data')['fiscal_end']) ? $this->session->userdata('post_data')['fiscal_end'] : '')),
				'class' => 'form-control',
			);
			$this->data['db_name'] = array(
				...
				'id'    => 'db_name',
				'type'  => 'text',
				'value' => $this->form_validation->set_value('db_name', (isset($this->session->userdata('post_data')['db_name']) ? $this->session->userdata('post_data')['db_name'] : '')),
				'class' => 'form-control',
			);
			$this->data['db_host'] = array(
				...
				'id'    => 'db_host',
				'type'  => 'text',
				'value' => $this->form_validation->set_value('db_host', (isset($this->session->userdata('post_data')['db_host']) ? $this->session->userdata('post_data')['db_host'] : '')),
				'class' => 'form-control',
			);
			$this->data['db_port'] = array(
				...
				'id'    => 'db_port',
				'type'  => 'text',
				'value' => $this->form_validation->set_value('db_port', (isset($this->session->userdata('post_data')['db_port']) ? $this->session->userdata('post_data')['db_port'] : '')),
				'class' => 'form-control',
				'placeholder' => '3306'
			);
			$this->data['db_username'] = array(
				...
				'id'    => 'db_username',
				'type'  => 'text',
				'value' => $this->form_validation->set_value('db_username', (isset($this->session->userdata('post_data')['db_username']) ? $this->session->userdata('post_data')['db_username'] : '')),
				'class' => 'form-control',
			);
			$this->data['db_password'] = array(
				...
				'id'    => 'db_password',
				'type'  => 'text',
				'value' => $this->form_validation->set_value('db_password', (isset($this->session->userdata('post_data')['db_password']) ? $this->session->userdata('post_data')['db_password'] : '')),
				'class' => 'form-control',
			);
			$this->data['db_prefix'] = array(
				...
				'id'    => 'db_prefix',
				'type'  => 'text',
				'value' => $this->form_validation->set_value('db_prefix', (isset($this->session->userdata('post_data')['db_prefix']) ? $this->session->userdata('post_data')['db_prefix'] : '')),
				'class' => 'form-control',
			);
			// render page
		$this->render('admin/import_existing_account');
		}
	}
	...
	public function create_account()
	{
		...
		if ($this->form_validation->run() == TRUE) {
 		...
 		// 	$schema = file_get_contents(APPPATH.'config/Functions.Mysql.sql');
			...
			$uploadData = '';
            $uploadPath = 'assets/uploads/logo/';
			...
			$this->data['address'] = array(
				...
				'id'    => 'address',
				'type'  => 'textarea',
				'value' => $this->form_validation->set_value('address', (isset($this->session->userdata('post_data')['address']) ? $this->session->userdata('post_data')['address'] : '')),
				'class' => 'form-control',
			);
			$this->data['email'] = array(
				'name'  => 'email',
				'id'    => 'email',
				'type'  => 'email',
				'value' => $this->form_validation->set_value('email', (isset($this->session->userdata('post_data')['email']) ? $this->session->userdata('post_data')['email'] : '')),
				'class' => 'form-control',
			);
			$this->data['currency'] = array(
				...
				'id'    => 'currency',
				'type'  => 'text',
				'value' => $this->form_validation->set_value('currency', (isset($this->session->userdata('post_data')['currency']) ? $this->session->userdata('post_data')['currency'] : '')),
				'class' => 'form-control',
			);
			$this->data['decimal_place'] = array(
				...
				'id'    => 'decimal_place',
				'type'  => 'text',
				'value' => $this->form_validation->set_value('decimal_place', (isset($this->session->userdata('post_data')['decimal_place']) ? $this->session->userdata('post_data')['decimal_place'] : '')),
				'class' => 'form-control',
			);
			$this->data['fiscal_start'] = array(
				'name'  => 'fiscal_start',
			...
			// 	'id'    => 'db_schema',
			// 	'type'  => 'text',
			// 	'value' => $this->form_validation->set_value('db_schema', (isset($this->session->userdata('post_data')['db_schema']) ? $this->session->userdata('post_data')['db_schema'] : '')),
			// 	'class' => 'form-control',
			// );
			$this->data['db_host'] = array(
				'name'  => 'db_host',
